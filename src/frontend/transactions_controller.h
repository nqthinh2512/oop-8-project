...
public:
    ...
    // CRUD Operations
    Q_INVOKABLE void addTransaction(int typeIndex, const QString& title, double amount, const QString& dateStr, int categoryId, const QString& method, int linkedBillId = -1, int linkedSavingId = -1, int linkedBudgetId = -1);
    Q_INVOKABLE void updateTransaction(int id, int typeIndex, const QString& title, double amount, const QString& dateStr, int categoryId, const QString& method, int linkedBillId = -1, int linkedSavingId = -1, int linkedBudgetId = -1);
